...
const Tab = ({ children, tab, handleSetSelected, selected }) => {
  return (
    <Button
      ...
      style={{
        color: selected === tab ? "#4f46e5" : "#000000", // Primary and neutral colors
      }}
      className={`flex items-center gap-1 px-3 py-1.5 text-sm transition-all ${
        selected === tab
          ? "text-indigo-500" // Color change for selected
          : "text-neutral-400" // Neutral color for unselected
      }`}
    >
      <span>{children}</span>
    </Button>
    ...
    <div>
      <div className="flex gap-4">
        <div>
          ...
          <a href="#" className="mb-1 block text-sm text-neutral-400 hover:text-neutral-50">
            Bookkeeping
          </a>
          <a href="#" className="block text-sm text-neutral-400 hover:text-neutral-50">
            Invoicing
          </a>
        </div>
        <div>
    ...
    <div>
      <div className="grid grid-cols-2 gap-2">
        <a href="#">
          ...
          />
          <h4 className="mb-0.5 text-sm font-medium">Valorant Blog</h4>
          <p className="text-xs text-neutral-400">
            I'm here playing phoenix in ascent. I'm gonna blind a couple of enemies and take a couple of picks.
          </p>
        </a>
        <a href="#">
          <img
